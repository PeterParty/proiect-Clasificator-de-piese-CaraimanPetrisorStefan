...
**Student:** [Caraiman Petrisor]  
**[Link Repository GitHub](https://github.com/PeterParty/proiect-Clasificator-de-piese)**
**Data:** [04.12.2025]  
---
...
<!-- todo: livrez Schelet complet si fucntional al întregului Sistem cu Inteligență Artificială(SIA)
...
<!-- todo: de coompletat acuratețea -->
| **Nevoie reală concretă** | **Cum o rezolvă SIA-ul vostru** | **Modul software responsabil** |
|---------------------------|--------------------------------|--------------------------------|
|Diferențiera automată a diferitelor piese |Clasificare automată a diferitelor piese -> ...% acuratețe |RN + UI +Camera Video |
|Soratarea automată a diferitelor piese|Clasificarea automată a diferitelor piese și trimitrea unui semnal al motor ->latenta ->|RN + UI +Camera Video + Motor pentru directionare piese |
...
<!-- Todo : de completat -->
În proces de creare si căutare a datelor (poze cu flanse,bucse,arbori)
<!-- 
...
<!-- todo de completat contributia -->
| **Tip contribuție** | **Exemple concrete din inginerie** | **Dovada minimă cerută** |
|---------------------|-------------------------------------|--------------------------|
| **Imagini cu piese in CATIA V5 si Solidworks** | * ...  |*...|
